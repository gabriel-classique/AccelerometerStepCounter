...
import com.xcvi.stepcounter.service.accdetec.SensorFusionMath.dot
import com.xcvi.stepcounter.service.accdetec.SensorFusionMath.norm
import com.xcvi.stepcounter.service.accdetec.SensorFusionMath.sum

class AccelerometerSensorDetector(
    context: Context,
    ...
    override fun registerListener(stepListener: StepListener): Boolean {
        ...
        if (stepDetectorSensor != null) {
            return sensorManager?.registerListener(
                /* listener = */ this@AccelerometerSensorDetector,
    ...
    override fun unregisterListener() {
        stepListener = null
        sensorManager?.unregisterListener(this@AccelerometerSensorDetector)
    }
